...
class Locomotive 
{
	...
	Cuboid Chimney1 = Cuboid({ 0,0.2,-0.4 }, { 0.2,0.6,0.2 }, glm::vec3(0, 0, 0));
	Cuboid ChimneyTop1 = Cuboid({ 0,0.5,-0.4 }, { 0.3,0.1,0.3 }, glm::vec3(0, 0, 0));
	Cuboid Chimney2 = Cuboid({ 0,0.2,-1.0 }, { 0.2,0.6,0.2 }, glm::vec3(0, 0, 0));
	Cuboid ChimneyTop2 = Cuboid({ 0,0.5,-1.0 }, { 0.3,0.1,0.3 }, glm::vec3(0, 0, 0));
	...
	Cuboid BailRight = Cuboid({ 0.51,0.13,- 1 }, { 0.02,0.07,2.1 }, glm::vec3(1, 1, 1));
	Cuboid BailLeft = Cuboid({ -0.51,0.13,- 1 }, { 0.02,0.07,2.1 }, glm::vec3(1, 1, 1));
